            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <h1 class="h3 align-middle mb-0">Data Geografis</h1>
                    ...
                    <form method="POST" class="form-setting" action="{{ route('geografis.update') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="card-body">
                            ...
                            <textarea name="deskripsi" id="summernote" class="form-control" cols="30" rows="10" required></textarea>
                        </div>
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
    <script src="{{ asset('assets/backsite/vendors/summernote/summernote.min.js') }}"></script>
    <script>
