            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <h1 class="h3 align-middle mb-0">Tambah Data Perangkat Desa</h1>

                    </div>

                    <form method="POST" class="form-setting" action="{{ route('perangkat.store') }}"
                        ...
                        <div class="card-body">
                            ...
                            <input name="jabatan" id="jabatan" type="text" class="form-control @error('jabatan') is-invalid @enderror" value="{{old('jabatan')}}">
                            @error('jabatan')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
