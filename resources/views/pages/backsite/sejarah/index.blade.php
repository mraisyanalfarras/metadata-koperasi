            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <h1 class="h3 align-middle mb-0">Data Sejarah</h1>
                    ...
                    <form method="POST" class="form-setting" action="{{ route('sejarah.update') }}" enctype="multipart/form-data">
                        @csrf
