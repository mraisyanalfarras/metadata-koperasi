            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <h1 class="h3 align-middle mb-0">Tambah Data Fasilitas</h1>

                    </div>

                    <form method="POST" class="form-setting" action="{{ route('fasilitas.store') }}"
                        ...
                        <div class="card-body">
                            ...
                            <input name="maps" id="maps" type="url" class="form-control @error('maps') is-invalid @enderror" value="{{old('maps')}}">
                            @error('maps')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
